...
namespace IhChegou.Repository.Model.Parser.Product
{
    ...
    {
        public static DtoSearch ToDTO(this Repository.Pharma.Model.Products.Search model)
        {
            if (model == null)
                return null;
            ...
            dto.Views = model.Views;

            return dto;
        }

        public static List<DtoSearch> ToDTO(this IEnumerable<Repository.Pharma.Model.Products.Search> model)
        {
